...
#baseOutDir = 'results/UL2017_Check/fit80_110/test_cutbase/'
#baseOutDir = 'results/UL2017_Check/fit60_120/test/WithoutPhoton_Cut
#baseOutDir = 'results/UL2017_Check/fit60_120/test/Barrel/egamma'
baseOutDir = 'results/UL2017_Check/fit60_120/test/Barrel/oldmedium'
#baseOutDir = 'results/UL2017_Check/fit80_110/withoutsigma'
#############################################################
...
biningDef = [
    ...
    { 'var' : 'ph_sc_eta' , 'type': 'float', 'bins': [-1.4442,-0.5,0.0,0.5,1.4442] },
#    { 'var' : 'ph_sc_eta' , 'type': 'float', 'bins': [-2.5,-2.0,-1.566,1.566,2.0,2.5] },
#    { 'var' : 'ph_sc_eta' , 'type': 'float', 'bins': [1.566,2.0,2.5] },
